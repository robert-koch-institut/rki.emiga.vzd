Instance: InekEinricthung02
InstanceOf: EmigaHospitalFacilityLocationR6
Usage: #example
...
* status = #active
* name = "Josephs-Hospital Warendorf - Stationäre Behandlung"
* mode = #instance

* type.coding.system = $IneKFacilityTypeCS 
* type.coding.code = #00
* type.coding.display = "Stationäre Behandlung"
...
* position.latitude = 51.960868434217
* position.longitude = 8.00270318985
* position.extension[UTMCoordinates].extension[UTM_Zone].valueString = "32U"
* position.extension[UTMCoordinates].extension[UTM_Easting_X].valueDecimal = 431476
* position.extension[UTMCoordinates].extension[UTM_Northing_Y].valueDecimal = 5757156
