Profile: EmigaHospitalFacilityLocationR6
Parent: Location
Id: EmigaHospitalFacilityLocationR6
...
* meta.profile[emigaprofile] = "https://emiga.rki.de/fhir/vzd/StructureDefinition/EmigaHospitalFacilityLocationR6"
...
* identifier[abrechnungs-IKNR] only $identifier-iknr
* identifier[abrechnungs-IKNR] ^definition = "Die ARGE·IK vergibt und pflegt so genannte Institutionskennzeichen (IK). Das sind neunstellige Ziffernfolgen"
* identifier[abrechnungs-IKNR] ^patternIdentifier.system = "http://fhir.de/sid/arge-ik/iknr"
* identifier[abrechnungs-IKNR].system 1.. MS
* identifier[abrechnungs-IKNR].value 1.. MS
* identifier[abrechnungs-IKNR].period 0..1 MS
...
// AUTO-DISABLED (SUSHI R6): * physicalType.coding.code = #wa
// AUTO-DISABLED (SUSHI R6): * physicalType.coding.display MS
// AUTO-DISABLED (SUSHI R6): * physicalType.coding.display = "Ward"
...
* managingOrganization only Reference(EmigaHospitalOrganizationR6)
...
* partOf MS
* partOf only Reference(EmigaHospitalLocationR6)
