Profile: EmigaPublicHealthLocationR6
Parent: Location
Id: EmigaPublicHealthLocationR6
...
* meta.profile[emigaprofile] = "https://emiga.rki.de/fhir/vzd/StructureDefinition/EmigaPublicHealthLocationR6"
...
* managingOrganization only Reference(EmigaPublicHealthOrganizationR6)
