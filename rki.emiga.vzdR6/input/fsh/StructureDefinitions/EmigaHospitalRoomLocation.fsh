Profile: EmigaHospitalRoomLocationR6
Parent: Location
Id: EmigaHospitalRoomLocationR6
...
* meta.profile[emigaprofile] = "https://emiga.rki.de/fhir/vzd/StructureDefinition/EmigaHospitalRoomLocationR6"
