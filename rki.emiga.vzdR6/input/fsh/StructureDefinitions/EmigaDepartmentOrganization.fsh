Profile: EmigaDepartmentOrganizationR6
Parent: Organization
Id: EmigaDepartmentOrganizationR6
Title: "Fachabteilung"
...
* meta.profile[emigaprofile] = "https://emiga.rki.de/fhir/vzd/StructureDefinition/EmigaDepartmentOrganizationR6"

// 'Additional content defined by implementations' - 0..* - Extension
// Wird für die EMIGA Anwendungsfälle derzeit nicht benötigt
// Update: extension benuzt um den Zeitraum der Gültigkeit der Organisation abzubilden
* extension MS
// AUTO-DISABLED (SUSHI R6): * extension contains $OrganizationPeriod named organizationPeriod 0..*
