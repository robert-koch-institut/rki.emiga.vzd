Profile: EmigaPractitionerRoleR6
Parent: PractitionerRole
Id: EmigaPractitionerRoleR6
...
* practitioner 1..1 MS
* practitioner only Reference(EmigaPractitionerR6)
...
* organization 1..1 MS
* organization only Reference(EmigaOrganizationR6 or EmigaPublicHealthOrganizationR6)
...
* location 0..1 MS
* location only Reference(EmigaLocationR6)
...
* healthcareService only Reference(EmigaHealthcareServiceR6)
