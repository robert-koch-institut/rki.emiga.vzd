Profile: EmigaHospitalOrganizationR6
Parent: Organization
Id: EmigaHospitalOrganizationR6
Title: "Krankenhaus"
...
* insert ProfileMetaProfileTags
* meta.profile[emigaprofile] = "https://emiga.rki.de/fhir/vzd/StructureDefinition/EmigaHospitalOrganizationR6"
...
// AUTO-DISABLED (SUSHI R6): 
// AUTO-DISABLED (SUSHI R6): * address 0..1 MS
