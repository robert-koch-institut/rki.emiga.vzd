...
* $OrganizationType#authority ^designation[=].use = $sct#900000000000003009
...
* $OrganizationType#sepFedAut ^designation[=].use = $sct#900000000000003009
...
* $OrganizationType#hiFedAut ^designation[=].use = $sct#900000000000003009
...
* $OrganizationType#fedInsti ^designation[=].use = $sct#900000000000003009
...
* $OrganizationType#supFedStaAut ^designation[=].use = $sct#900000000000003009
...
* $OrganizationType#otherAutFed ^designation[=].use = $sct#900000000000003009
...
* $OrganizationType#otherAutState ^designation[=].use = $sct#900000000000003009
...
* $OrganizationType#intOrg ^designation[=].use = $sct#900000000000003009 
...
* $OrganizationType#resFacility ^designation[=].use = $sct#900000000000003009 
...
* $OrganizationType#otherOrg ^designation[=].use = $sct#900000000000003009 
...
* $OrganizationType#transport ^designation[=].use = $sct#900000000000003009 
...
* $OrganizationType#airport ^designation[=].use = $sct#900000000000003009 
...
* $OrganizationType#harbor ^designation[=].use = $sct#900000000000003009 
