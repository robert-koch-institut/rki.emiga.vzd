...
* identifier[EmigaFileNumber].value = "[Arztpraxis][1.][2026]-[24681357]"
...
// ----------------------------------------------------
* name = "Musterpraxis Dr. Max Mustermann"
...
* telecom[Email][0].value = "kontakt@musterpraxis.de"
...
* telecom[Url][0].value = "https://www.musterpraxis.de"
