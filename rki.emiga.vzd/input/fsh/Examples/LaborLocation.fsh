Instance: LaborLocation
InstanceOf: EmigaLocation
Usage: #example

* meta.profile[emigaprofile] = "https://emiga.rki.de/fhir/vzd/StructureDefinition/EmigaLocation|2.0.0-alpha.11"
