...
| Krankenhaus (EmigaHospitalOrganization) | Profil zur Abbildung eines Krankenhaus im Kontext von EMIGA. Es dient der strukturierten Erfassung von Stammdaten des Krankenhauses (z. B. Name, Kennziffern, Kontakt- und Adressdaten). |
...
| Krankenhaus - Standort (EmigaHospitalLocation) | Dieses Profil bildet einen Standort eines Krankenhauses im Kontext von EMIGA ab. Es dient der strukturierten Erfassung von besuchbaren Krankenhaus-Standorten (z. B. Hauptstandort, Klinikgebäude, Stationen). |
...
| Organisationsverzeichnis Bundle (OrgVBundle) | Dieses Bundle bildet Informationen zum Organisationsverzeichnis ab. Es dient der strukturierten Zusammenführung und gemeinsamen Übertragung von Organisationen und zugehörigen Ressourcen im Rahmen eines Organisationsverzeichnisses." |
