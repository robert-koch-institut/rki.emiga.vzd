---
topic: EmigaPublicHealthLocation
canonical: https://emiga.rki.de/fhir/vzd/StructureDefinition/EmigaPublicHealthLocation
---
...
<tabs>
    <tab title="Übersicht">      
        {{render:Location-PublicHealthLocation001.json}}
    </tab>
    <tab title="XML">      
        {{xml:Location-PublicHealthLocation001.json}}
    </tab>
    <tab title="JSON">
        {{json:Location-PublicHealthLocation001.json}}
    </tab>
    <tab title="Link">
        {{link:Location-PublicHealthLocation001.json}}
    </tab>
</tabs>
