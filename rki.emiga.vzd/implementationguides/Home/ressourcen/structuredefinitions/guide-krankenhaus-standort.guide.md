---
topic: EmigaHospitalLocation
canonical: https://emiga.rki.de/fhir/vzd/StructureDefinition/EmigaHospitalLocation
---
...
## Beispiel
Im Folgenden wird ein Beispiel für einen fiktiven Krankenhaus Standort dargestellt.

<tabs>
    <tab title="Übersicht">      
        {{render:Location-IneKStandort.json}}
    </tab>
    <tab title="XML">      
        {{xml:Location-IneKStandort.json}}
    </tab>
    <tab title="JSON">
        {{json:Location-IneKStandort.json}}
    </tab>
    <tab title="Link">
        {{link:Location-IneKStandort.json}}
    </tab>
</tabs>

<!-- {{json: Location/IneKStandort}} -->